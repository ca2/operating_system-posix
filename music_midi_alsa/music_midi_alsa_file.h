...
/*         double GetTempoShiftRate();
         ...
         int32_t WorkCalcMelodyTrack(::music::midi::happenings ** ppEvents, imedia::position_array & positiona, ::i32_array_base & iaTokenLine);
         ...
         ::e_status StreamEvent(imedia::position tickDelta, ::music::midi::happening * Event, LPMIDIHDR lpmh, imedia::position tickMax, ::u32 cbPrerollNomimalMax);

         ::e_status StreamEventF1(imedia::position tickDelta, array < ::music::midi::happening *, ::music::midi::happening * > & eventptra, LPMIDIHDR lpmh, imedia::position tickMax, ::u32 cbPrerollNomimalMax);
