   ...
   namespace midi
   {
      ...
      namespace alsa
      {
            ...
            ::music::midi::player(pparticle)
         {
            ...
            m_psequencethread = __sp(___new ::music::midi::alsa::sequence_thread(this));
         ...
         bool player::Play(imedia_position tickStart, unsigned int dwEllapse)
         {

            auto pcommand = __sp(___new ::music::midi::player_command(this));
         ...
         bool player::ExecuteCommand(::music::midi::e_command ecommand, unsigned int dwEllapse)
         {
         ...
         void player::close_file()
         {
               ...
               mmrc != ::error_wrong_state)
            {
               ...
               __throw(___new ::multimedia::exception(::multimedia::exception_music, mmrc));
...
//            {
//               __throw(___new ::multimedia::exception(::multimedia::exception_midi, mmrc));
//            }
//
//         }
         ...
         bool player::SetTempoShift(int32_t iTempoShift)
         {
            ...
            {/*
             ...
             imedia::position tick = get_sequence()->GetPositionTicks();
...
//            {
//
//               auto pdata = __sp(aaa_memory_new ::music::midi::notify_event));
//
