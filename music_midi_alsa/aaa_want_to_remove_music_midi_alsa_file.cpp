...
//               (::u32)(byte)(m_dwTimeDivision & 0xFF);
//
//            return (::u32)muldiv32((int32_t) tkOffset, 1000L, dwTicksPerSec);
//         }
//
...
//               uSMPTE = 30;
//
//            dwTicksPerSec = (::u32)uSMPTE * (::u32)(byte)(m_dwTimeDivision & 0xFF);
//
...
//      }
//
//      ::e_status file::StreamEventF1(imedia::position tkDelta,
