...
//CLASS_DECL_WINDOWING_GTK4 void x11_main();


//CLASS_DECL_WINDOWING_GTK4 ::particle * user_synchronization();
...
//CLASS_DECL_WINDOWING_GTK4 enum_net_wm_state net_wm_state(const char * pszText);
//
//
//CLASS_DECL_WINDOWING_GTK4 const char * net_wm_state_text(enum_net_wm_state estate);
