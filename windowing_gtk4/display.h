...
//      Atom                                         m_atomNetWmSyncRequestCounter;
      ...
      ::pointer<::windowing_gtk4::window>           m_pwindowActive;
...
//      virtual void __handle_pointer_enter(::wl_pointer * pwlpointer, double x, double y, ::windowing_gtk4::window * pwindowPointerEnter);
//      virtual void __handle_pointer_motion(::wl_pointer * pwlpointer, double x, double y, ::u32 time);
//      virtual void __handle_pointer_leave(::wl_pointer * pwlpointer, ::windowing_gtk4::window * pwindowPointerLeave);
//
//      virtual void __handle_pointer_button(::wl_pointer * pwlpointer, ::u32 linux_button, ::u32 pressed, ::u32 time);
//
//
//      //virtual void __capture_mouse(::windowing_gtk4::window * pwindowMouseCapture, ::u32 serial);
//
//
