...
#if defined(_windowing_system_gtk4_project)
#define CLASS_DECL_WINDOWING_SYSTEM_GTK4  CLASS_DECL_EXPORT
#else
#define CLASS_DECL_WINDOWING_SYSTEM_GTK4  CLASS_DECL_IMPORT
#endif
