...
//void xxxshow_error_message(const ::string & strMessage, const ::string & strTitle, const ::e_message_box & emessagebox = e_message_box_ok, const ::future & process = nullptr);
