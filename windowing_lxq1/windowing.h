...
#include "acme_windowing_lxq1/windowing.h"
#include "windowing_q5/windowing.h"
...
namespace windowing_lxq1
{
   ...
   class CLASS_DECL_WINDOWING_LXQ1 windowing :
      virtual public ::windowing_q5::windowing,
      virtual public ::lxq1::acme::windowing::windowing
   {
   public:
