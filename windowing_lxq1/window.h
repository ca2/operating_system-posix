...
namespace windowing_lxq1
{
   ...
   class CLASS_DECL_WINDOWING_LXQ1 window :
      virtual public ::windowing_q5::window,
      virtual public ::lxq1::acme::windowing::window
