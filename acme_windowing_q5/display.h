//
// From acme_windowing_gkt3/display on 2025-01-10 01:17 <3ThomasBorregaardSorensen!!
...
//         using window_map = map<::QWidget *, ::pointer<window> >;
         ...
         class CLASS_DECL_ACME_WINDOWING_Q5 display :
            virtual public ::q::acme::windowing::display //,     virtual public event_listener
         {
         public:
