...
namespace acme_windows
{
   ...
   public:
      ...
      void start_program_files_app_app_admin(const ::scoped_string & scopedstrPlatform, const ::scoped_string & scopedstrConfiguration) override;
...
//#endif
      ...
      ::i32_size get_main_monitor_size() override;
