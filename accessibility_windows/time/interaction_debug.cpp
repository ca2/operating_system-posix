...
bool __windows_message_bypass(::acme::windowing::window * pacmewindowingwindow, ::user::enum_message eusermessage, ::wparam wparam, ::lparam lparam, LRESULT & lresult, ::u32 * puia)
{
