...
//int xcb_message_box(const ::scoped_string & scopedstr, const ::scoped_string & scopedstrTitle, const ::user::e_message_box & emessagebox)
//{
//
...
//CLASS_DECL_ACME void xcb_message_box(const ::scoped_string & scopedstrMessage, const ::scoped_string & scopedstrTitle, const ::user::e_message_box & emessagebox, const ::promise::process & process);

//::e_status message_box_synchronous(::acme::windowing::window * pacmewindowingwindow, const_char_pointer pszMessage, const_char_pointer pszTitle, const ::user::e_message_box & emessagebox, ::future future)
//{
//
