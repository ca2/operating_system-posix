...
bool XkbSymbolParser::isXkbLayoutSymbol(const string& symbol) {
    ::collection::collection::index result = _nonSymbols.find_first(symbol);
    return result < 0;
}
...
{
    ::collection::collection::index it1 = 0;
    ::collection::collection::index it2 = 0;
...
//    CLASS_DECL_ACME ::user::e_key keysym_to_userkey(const lparam & lparam)
//    {
