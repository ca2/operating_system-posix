...
namespace windowing_xcb
{
   ...
   public:
      ...
      //void show_software_keyboard(::user::interaction_base * pprimitive, const ::scoped_string & scopedstr, character_count iBeg, character_count iEnd) override;

      //void hide_software_keyboard(::user::interaction_base * pprimitive) override;
