...
namespace windowing_xcb
{
   ...
   public:
      ...
      virtual ::e_status _get_window_rectangle(::i32_rectangle * prectangle);
      virtual ::e_status _get_client_rectangle(::i32_rectangle * prectangle);
      ...
      //virtual ::e_status this->rectangle(::i32_rectangle * prectangle);
