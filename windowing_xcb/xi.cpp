...
//
//
//   void windowing::xcb_register_extended_event_listener(::matter *pdata, bool bMouse, bool bKeyboard)
//   {
//
...
//
//                             ::windowing_xcb::display_lock lock(m_pdisplay);
//
//                             int event, error;
//
//                             if (!XQueryExtension(m_pdisplay->xcb_connection(), "XInputExtension", &m_xi_opcode, &event,
//                                                  &error))
//                             {
//
...
//                             if (!use_root)
//                                return;
//                             win = DefaultRootWindow(m_pdisplay->xcb_connection_t());
//                             //else
...
//                         */
//
//                             XISelectEvents(m_pdisplay->xcb_connection(), win, &mask[0], use_root ? 2 : 1);
//                             //if (!use_root) {
//                             //  XISelectEvents(display, DefaultRootWindow(display), &mask[1], 1);
//                             //XMapWindow(display, win);
//                             //
//                             XSync(m_pdisplay->xcb_connection(), false);
//
//                             free(mask[0].mask);
//                             free(mask[1].mask);
//
