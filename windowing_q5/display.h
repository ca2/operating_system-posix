...
namespace windowing_q5
{
   ...
   class CLASS_DECL_WINDOWING_Q5 display :
      virtual public ::windowing_q::display,
      virtual public ::q5::acme::windowing::display
   {
   public:
...
// //      virtual ::windowing_kde5::window * _window(::wl_surface * pwlsurface);
      ...
      virtual ::windowing_q5::windowing * q5_windowing();
...
// //
// //
// //      //virtual void __capture_mouse(::windowing_kde5::window * pwindowMouseCapture, ::u32 serial);
// //
// //
