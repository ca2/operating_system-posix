...
//#include "acme_windowing_q5/windowing.h"
...
namespace windowing_q5
{
   ...
   {
      ::windowing_q::windowing::initialize_windowing();
   }
   //
   //    void windowing::initialize_windowing()
    //   {
   ...
   {
      windowing_q::windowing::windowing_post_quit();
   ...
   //
       bool windowing::defer_release_mouse_capture(::thread * pthread, ::acme::windowing::window * pwindow)
       {
          ...
          return ::windowing_q::windowing::defer_release_mouse_capture(pthread, pwindow);
   ...
   //
       void windowing::_main_send(const ::procedure & procedure)
       {
          ...
          ::windowing_q::windowing::_main_send(procedure);
   ...
   void windowing::_user_post(const ::procedure & procedure)
   {
      ...
      ::windowing_q::windowing::_user_post(procedure);
   }
   //    void windowing::_user_post(const ::procedure & procedure)
   //    {
   //        ::q5::acme::windowing::windowing::_user_post(procedure);
   ...
   //
       ...
       {
      ::windowing_q::windowing::windowing_application_main_loop();
}
//
//    void windowing::windowing_application_main_loop()
//    {
