...
namespace windowing_q5
{
   ...
   //
       void window::defer_show_system_menu(::user::mouse* pmouse)
       {
          ...
          ::windowing_q::window::defer_show_system_menu(pmouse);
}
...
//
   ...
   {
      windowing_q::window::_on_reposition(x, y);
   }
...
//
   ...
   {
      windowing_q::window::_on_size(cx, cy);
   }
...
//
   ...
   {
      windowing_q::window::_on_mouse_press(pevent);
   }
//
//    void window::_on_mouse_press(QMouseEvent* pevent)
//    {
...
//
   ...
   {
      windowing_q::window::_on_mouse_release(pevent);
   }
//
//    void window::_on_mouse_release(QMouseEvent* pevent)
//    {
...
//
   ...
   {
      windowing_q::window::_on_mouse_motion(pevent);
   }
//    //
...
//
      ...
      ::windowing_q::window::_on_key_press(pevent);
...
//
//              int i1 = strText.c_str()[0];
//              int i2 = strText.c_str()[1];
//              int i3 = strText.c_str()[2];
//              int i4 = strText.c_str()[3];
//
//               if (strText.has_character() && (strText[0] >=32 || strText[0] < 0))
//               {
//                  on_text(strText.c_str(), strText.size());
//               }
//
//              //if (pevent->button() == Qt::MouseButton::LeftButton)
//              // {
...
//
                 ...
                 void window::_on_key_release(QKeyEvent * pevent)
   {
      ...
      ::windowing_q::window::_on_key_release(pevent);
...
//    {
//
//       on_text(scopedstr.begin(), scopedstr.size());
//
//
//    }
//
...
//
      ...
      ::windowing_q::window::_on_qimage_draw(pqimage);
...
//m_puserinteractionbase = puserinteraction;
    ...
    void window::destroy()
    {
       ::windowing_q::window::destroy();

       ::q5::acme::windowing::window::destroy();
    }
...
//
//
    ::windowing_q5::windowing* window::q5_windowing()
    {

       ::cast <::windowing_q5::windowing > pwindowing = system()->acme_windowing();
...
//
    void window::set_mouse_capture()
    {
       ...
       ::windowing_q::window::set_mouse_capture();
...
//
    bool window::has_mouse_capture()
    {
       ...
       if(!::windowing_q::window::has_mouse_capture())
       {
    ...
    bool window::is_mouse_captured()
    {
       ...
       if(!::windowing_q::window::is_mouse_captured())
       {
    ...
    void window::release_mouse_capture()
   {
       ::windowing_q::window::release_mouse_capture();

    }
       void window::set_active_window()
       {

      ::windowing_q::window::set_active_window();
...
//          {
//             puserinteraction->layout().m_statea[::user::e_layout_sketch].activation().m_eactivation =::user::e_activation_set_active;
//          }
//
//          return;
//       }
       ...
       bool window::has_keyboard_focus()
{
      ...
      if (!::windowing_q::window::has_keyboard_focus())
      {
...
//       //return false;
//
//       return ::q5::acme::windowing::window::has_keyboard_focus();
//
//    }
//
//
...
//
       void window::set_keyboard_focus()
       {
          ...
          ::windowing_q::window::set_keyboard_focus();
...
//
    bool window::is_active_window()
    {
       ...
       return ::windowing_q::window::is_active_window();
...
//
       bool window::defer_perform_entire_resizing_process(::experience::enum_frame eframeSizing, ::user::mouse* pmouse)
       {
          ...
          return ::windowing_q::window::defer_perform_entire_resizing_process(eframeSizing, pmouse);
...
//    //
       ...
       bool window::defer_perform_entire_reposition_process(::user::mouse* pmouse)
       {
          ...
          return ::windowing_q::window::defer_perform_entire_reposition_process(pmouse);
