...
//CLASS_DECL_WINDOWING_WAYLAND enum_net_wm_state net_wm_state(const_char_pointer pszText);
//
//
//CLASS_DECL_WINDOWING_WAYLAND const_char_pointer net_wm_state_text(enum_net_wm_state estate);
