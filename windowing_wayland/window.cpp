...
namespace windowing_wayland
{
   ...
   void window::create_window(::user::interaction_impl * pimpl)
   {
...

      {
         ...
         auto pdisplayx11 = dynamic_cast < ::windowing_wayland::display * > (pwindowingdisplay);
         ...
         m_pwlbuffer = ::windowing_wayland::_create_buffer({cx, cy});

         wl_surface_attach(m_pwlsurface, m_pwlbuffer, 0, 0);
...
//      }
   ...
   ::windowing_wayland::windowing * window::x11_windowing() const
   {
   ...
   ::windowing_wayland::display * window::x11_display() const
   {
