...
namespace acme_windows
{
   ...
   public:
      ...
      ::file::path time_put_contents(const ::file::path & pathFolder, const ::scoped_string & scopedstrPrefix, const ::scoped_string & scopedstrExtension, const ::scoped_string & scopedstr) override;
