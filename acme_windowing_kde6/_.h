...
#if defined(_acme_windowing_system_kde6_project)
#define CLASS_DECL_ACME_WINDOWING_SYSTEM_KDE6 CLASS_DECL_EXPORT
#else
#define CLASS_DECL_ACME_WINDOWING_SYSTEM_KDE6 CLASS_DECL_IMPORT
#endif
