...
//   bool node::set_wallpaper(::collection::collection::index iScreen, string strLocalImagePath)
//   {
//
...
//
//                              for (::collection::collection::index iMonitor = 0; iMonitor < iMonitorCount; iMonitor++)
//                              {
//
