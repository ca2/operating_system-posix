...
namespace node_kde5
{
   ...
   ::e_status notify_icon::_populate_qmenu_popup(QMenu * pmenuPopup, application_menu * papplicationmenu)
   {
      ...
      for (::raw::index i = 0; i < papplicationmenu->count(); i++)
      {
   ...
   ::e_status notify_icon::_populate_qmenu(QMenu * pmenu, ::raw::index i, application_menu * papplicationmenu)
   {
      ...
      {
//      for (::raw::index i = 0; i < m_papplicationmenu->get_count(); i++)
//      {
//
