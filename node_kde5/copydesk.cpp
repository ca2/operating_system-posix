...
//      ::pointer<clipboard_data>pdata = ::place(new clipboard_data(get_context_application(), e_clipboard_get_plain_text));
//
...
//      ::pointer<clipboard_data>pdata = ::place(new clipboard_data(get_context_application(), e_clipboard_get_file_target_count));
//
...
//      ::pointer<clipboard_data>pdata = ::place(new clipboard_data(get_context_application(), e_clipboard_get_patha));
//
...
//      ::pointer<clipboard_data>pdata = ::place(new clipboard_data(get_context_application(), e_clipboard_set_patha));
//
