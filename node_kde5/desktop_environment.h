...
namespace node_kde5
{
   ...
   class CLASS_DECL_NODE_KDE5 desktop_environment :
   ...
   public:
      ...
      //virtual ::e_status _get_monitor_rectangle(::collection::index iMonitor, ::i32_rectangle & rectangle);
      //virtual ::e_status _get_workspace_rectangle(::collection::index iMonitor, ::i32_rectangle & rectangle);


      //bool get_monitor_rectangle(::collection::index iMonitor, ::i32_rectangle & rectangle) override;
      //bool get_workspace_rectangle(::collection::index iMonitor, ::i32_rectangle & rectangle) override;
