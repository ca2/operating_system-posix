...
//void windowing_message_loop_add_idle_source(::node_gdk::node *pnode);


void g_settings_gtk_theme_name_callback(GObject *object, GParamSpec *pspec, gpointer data)
{
...
void g_settings_gtk_icon_theme_name_callback(GObject *object, GParamSpec *pspec, gpointer data)
{
...
namespace node_gdk
{
   ...
   node::node()
   {
      ...
      m_pactionWallpaper = nullptr;

      m_bGInitialized = false;
...
//   }
   ...
   void node::_fetch_dark_mode()
   {
      ...
      if(_gsettings_schema_exists("org.gnome.desktop.interface"))
      {
         ...
         if(_gsettings_schema_contains_key("org.gnome.desktop.interface", "color-scheme"))
         {
            ...
            if (_gsettings_get(strColorScheme, "org.gnome.desktop.interface", "color-scheme"))
            {
   ...
   void node::set_dark_mode(bool bDarkMode)
   {
      ...
      else
      {
         ...
         else
         {
            ...
            _gsettings_set("org.gnome.desktop.interface", "color-scheme", "prefer-light");
   ...
   ::e_status node::_os_set_user_theme(const ::string &strUserTheme)
   {
      ...
      if (edesktop & ::user::e_desktop_gnome)
      {
         ...
         //if(::file::system_short_name().case_insensitive_contains("manjaro"))
         {
            ...
            bOk2 = _gsettings_set("org.gnome.desktop.wm.preferences", "theme", strUserTheme).ok();
...
//         }
      ...
      switch (edesktop)
      {
         ...
         case ::user::e_desktop_unity_gnome:
         {
            ...
            if(bDark)
            {
               ...
               return _gsettings_set("org.gnome.desktop.background", "picture-uri-dark",
            ...
            else
            {
               ...
               return _gsettings_set("org.gnome.desktop.background", "picture-uri",
                                                "file://" + strLocalImagePath).ok();
   ...
   string node::get_file_icon_path(const ::string &strPath, int iSize)
   {
      ...
      return _g_get_file_icon_path(strPath, iSize);
   ...
   string node::get_file_content_type(const ::string &strPath)
   {
      ...
      return _g_get_file_content_type(strPath);
   ...
   void node::user_post_quit()
   {
      ...
      system()->windowing_system()->async([this]()
                                {
...
//   }
   ...
   ::string node::_get_os_user_theme()
   {
      ...
      if(_gsettings_schema_contains_key("org.gnome.desktop.interface", "gtk-theme"))
      {
...
//      }
   ...
   int node::os_launch_uri(const ::string &strUri, char *pszError, int iBufferSize)
   {
      ...
      int iRet = _gdk_launch_uri(strUri, pszError, iBufferSize);
...
//      file()->put_text(path, strXml);
   ...
   void node::_gdk_branch(const ::procedure & procedure)
   {
   ...
   gboolean windowing_message_loop_source_function(gpointer p)
   {
      ...
      ::node_gdk::node *pnode = (::node_gdk::node *) p;
   ...
   void node::_g_idle_add_windowing_message_loop()
   {

      g_idle_add(&windowing_message_loop_source_function, this);

   }


   int node::_gdk_launch_uri(const char * pszUri, char * pszError, int iBufferSize)
   {
...
//
      ...
      m_pactionWallpaper = g_settings_create_action(settings, strKey);

      g_object_unref(settings);

      g_signal_connect (m_pactionWallpaper, "notify::state", G_CALLBACK(wallpaper_change_notification), this);
   ...
   void node::_g_defer_term()
   {
      ...
      if (m_pactionWallpaper != nullptr)
      {
         ...
         g_object_unref(m_pactionWallpaper);
...
//      }
   ...
   ::e_status node::_gsettings_get(::string & str, const ::scoped_string & scopedstrSchema, const ::scoped_string & scopedstrKey)
   {
...
//      }
   ...
   void node::_g_safe_free(void * pfree)
   {
