...
namespace gtk4
{
   ...
   namespace nano
   {
      ...
      //
         ...
         ::GdkDisplay * display_base::__get_gdk_display()
         {
    ...
    for (guint i = 0; i < n_monitors; i++) {
       ...
       //m_monitora.add(pmonitor);
         ...
         ::GdkDisplay * display_base::_gdk_display() const
         {
         ...
         ::GtkWidget * display_base::_gtk_widget_focus()
         {
         ...
         //
         //
         // void display_base::__handle_pointer_button(::wl_pointer * pwlpointer, unsigned int linux_button, unsigned int pressed, unsigned int millis)
         // {
         //
         //    if (m_pwindowPointerCapture)
         //    {
