...
//#include "windowing_system_q6/windowing.h"
...
namespace windowing_q6
{
   ...
   windowing::windowing()
   {
      ...
      printf("windowing_q6::windowing::windowing()");
...
//
//
//       return ::q6::acme::windowing::windowing::defer_release_mouse_capture(pthread, pwindow);
//
//    }
//
...
//    {
//
//       ::q6::acme::windowing::windowing::windowing_post_quit();
...
//
//
//    ::windowing_q6::display* windowing::q6_display()
//    {
//
//       ::cast < ::windowing_q6::display > pdisplay = acme_display();
//
//       return pdisplay;
//
//    }
...
//
//
//    void windowing::_on_capture_changed_to(::windowing_q6::window * pwindowMouseCaptureNew)
//    {
//
//
//    }
...
//       }
//
//       ::cast < ::windowing_q6::cursor > pwaylandcursor = pcursor;
//
//       if (!pwaylandcursor)
//       {
//
...
//    {
//
//       ::q6::acme::windowing::windowing::_user_post(procedure);
...
//
//
//       ::q6::acme::windowing::windowing::windowing_application_main_loop();
