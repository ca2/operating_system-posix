...
//       ::q6::acme::windowing::window::on_initialize_particle();
//
//    }
//
//
...
//
//
//       ::q6::acme::windowing::window::defer_show_system_menu(pmouse);
//
//
...
//
//       pshowwindow->m_emessage = ::user::e_message_show_window;
//
...
//
//       psetkeyboardfocus->m_emessage = ::user::e_message_set_focus;
//
//       message_handler(psetkeyboardfocus);
//
//    }
//
//
...
//
//       pkillkeyboardfocus->m_emessage = ::user::e_message_kill_focus;
//
//       message_handler(pkillkeyboardfocus);
//
//    }
//
//
...
// //
// //         auto pq6windowing = q6_windowing();
// //
// //         auto pdisplay = pq6windowing->acme_display();
// //
// //         ////m_pwindow = pimpl;
// //
...
//    {
//
//       ::q6::acme::windowing::window::_create_window();
//
//    }
//
//
...
//
//
//    ::windowing_q6::windowing* window::q6_windowing()
//    {
//
//       ::cast < ::windowing_q6::windowing > pq6windowing = system()->acme_windowing();
//
//       if (!pq6windowing)
//       {
//
...
//
//
//    ::windowing_q6::display* window::q6_display()
//    {
//
...
//       }
//
//       ::cast < ::windowing_q6::display > pq6display = pwindowing->acme_display();
//
//       if (!pq6display)
//       {
//
...
//       }
//
//       auto pwindowx11NewParent = dynamic_cast<::windowing_q6::window *>(pwindowNewParent);
//
...
//       ::int_rectangle rBest;
//
//       auto pwindowingdisplay = q6_display();
//
//       int iMonitor = -1;
//
...
//             __check_refdbg;
//
//             ::cast < ::windowing_q6::cursor > pq6cursor = m_pcursor;
//
//             __check_refdbg;
//
//             if (pq6cursor)
...
//                __check_refdbg;
//
//                pq6cursor->_create_os_cursor();
//
//                __check_refdbg;
//
//                auto qcursor = pq6cursor->m_qcursor;
//
//                __check_refdbg;
//
...
//    {
//
//       ::q6::acme::windowing::window::set_mouse_capture();
//
//    }
//
//
...
//    {
//
//       if(!::q6::acme::windowing::window::has_mouse_capture())
//       {
//
//          return false;
//
...
//    {
//
//       if(!::q6::acme::windowing::window::is_mouse_captured())
//       {
//
//          return false;
//
...
//    {
//
//       ::q6::acme::windowing::window::release_mouse_capture();
//
//    }
//
//
...
//       // bool bFocus = false;
//       // main_send([this, &bFocus]()
//       // {
//       //
//       //    bFocus = m_pqwidget->hasFocus();
//       //
//       //
//       // });
//       // return bFocus;
...
//    {
//
//       return ::q6::acme::windowing::window::defer_perform_entire_resizing_process(eframeSizing,pmouse);
//
// //      auto pdisplay = q6_display();
// //
...
//    {
//       return ::q6::acme::windowing::window::defer_perform_entire_reposition_process(pmouse);
...
//    {
//
//       ::q6::acme::windowing::window::_main_send(procedure);
//
//    }
//
...
//    {
//
//       ::q6::acme::windowing::window::_main_post(procedure);
//
//    }
