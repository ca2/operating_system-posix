...
namespace windowing_q6
{
   ...
   public:
      ...
      void _on_show(bool bShow) override;
      ...
      ::windowing_q6::windowing* q6_windowing();
      ...
      bool _configure_window_unlocked(const class ::zorder& zorder, const ::user::activation& useractivation,
