...
virtual void initialize_window_manager();
      ...
      //bool process_modules(string_array_base & stra, ::u32 processID) override;
      ...
      //bool is_shared_library_busy(::u32 processid, const string_array_base & stra) override;
      //bool is_shared_library_busy(const string_array_base & stra) override;
      //bool process_contains_module(string & strImage, ::u32 processID, const ::scoped_string & scopedstrLibrary) override;
