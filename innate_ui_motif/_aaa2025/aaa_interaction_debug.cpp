...
bool __windows_message_bypass(oswindow oswindow, ::enum_message emessage, ::wparam wparam, ::lparam lparam, LRESULT & lresult, unsigned int * puia)
{
...
namespace windows
{
   ...
   bool interaction_impl::__windows_message_bypass(oswindow oswindow, ::enum_message emessage, ::wparam wparam, ::lparam lparam, LRESULT & lresult)
   {
      ...
      //}
      //else if (message == ::user::e_message_non_client_hittest)
      //{
