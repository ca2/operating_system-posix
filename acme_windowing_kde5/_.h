...
#if defined(_windowing_system_kde5_project)
#define CLASS_DECL_WINDOWING_SYSTEM_KDE5  CLASS_DECL_EXPORT
#else
#define CLASS_DECL_WINDOWING_SYSTEM_KDE5  CLASS_DECL_IMPORT
#endif
