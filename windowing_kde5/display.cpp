...
//
   ...
   //    information() << "Number of screens:" << iMonitorCount;
   //
   //    m_monitora.set_size(iMonitorCount);
   //
   //    ::collection::index iMonitor = 0;
   //
   ...
   //
   //       copy(pmonitor->m_rectangle, pscreen->geometry());
   //
   //       copy(pmonitor->m_rectangleWorkspace, pscreen->availableGeometry());
   //
   //    }
   //
   // }
...
//    {
//
//          // Check if the platform is Wayland
...
return ::kde5::acme::windowing::display::get_main_screen_size();
   ...
   void display::init_task()
   {
      ...
      ::kde5::acme::windowing::display::init_task();
   ...
   bool display::is_dark_mode_through_theming()
   {
      ...
      return ::kde5::acme::windowing::display::is_dark_mode_through_theming();

   }
   string display::theming_ui_name()
   {

      return ::kde5::acme::windowing::display::theming_ui_name();
   ...
   string display::impl_get_desktop_theme()
      ...
      return ::kde5::acme::windowing::display::impl_get_desktop_theme();

   }

   void display::impl_set_desktop_theme(const ::scoped_string & scopedstrTheme)
   {

      ::kde5::acme::windowing::display::impl_set_desktop_theme(scopedstrTheme);

   }
   void display::set_desktop_icon_theme(const ::scoped_string & scopedstrIconTheme)
   {

      ::kde5::acme::windowing::display::set_desktop_icon_theme(scopedstrIconTheme);
   ...
   bool display::is_branch_current() const
   {
      ...
      return ::kde5::acme::windowing::display::is_branch_current();
