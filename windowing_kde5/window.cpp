...
//         label->setText(QString("Mouse Moved to (%1, %2)")
  //           .arg(event->pos().x())
   ...
   void window::_on_qimage_draw(QImage * pqimage)
   {
      ...
      if(!m_puserinteractionimpl || !m_puserinteractionimpl->m_pgraphicsgraphics)
      {
      ...
      if(pitem && pitem->m_pimage2)
      {
         ...
         if(pitem->m_pimage2.ok())
         {
            ...
            ::copy_image32(pimageTarget,w, h, iTargetScan, pimageSource, iSourceScan);
...
::windowing_kde5::display* window::kde5_display()
{
      ...
      return dynamic_cast < ::windowing_kde5::display * > (m_pdisplay.m_p);
