...
//::e_status message_box_synchronous(::acme::windowing::window * pacmewindowingwindow, const char * pszMessage, const char * pszTitle, const ::::user::e_message_box & emessagebox, ::future future)
//{
//
