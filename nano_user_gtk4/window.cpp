...
namespace nano
{
   namespace user
   {
      ...
      void on_window_map(GtkWidget *widget, gpointer p) {
         ...
         //g_print("Widget has been mapped and is now visible on screen!\n");
      }
...
//             auto * menu_item1 = gtk_button_new_with_label("Option 1");
      ...
      // void window::set_interface_client_size(const ::size_i32 & sizeWindow) // m_sizeWindow
      // {
      //
      // }
...
//
//       }
      bool window::is_window_zoomed() // m_puserinteractionimpl->m_puserinteraction->const_layout().window().display() == e_display_iconic
      {

         return gtk_window_is_maximized(GTK_WINDOW(m_pgtkwidget));

      }
      void window::window_minimize() // m_puserinteractionimpl->m_puserinteraction->display(::e_display_zoomed);
      {
   ...
   //       }
      ...
      //
      //
      // void window::__handle_pointer_leave(::wl_pointer * pwlpointer, ::wayland::nano::user::window * pwaylandwindowLeave)
      // {
      //
      ...
      // bool window::_perform_entire_reposition_process()
      // {
      //
      ...
      // bool window::_perform_entire_resizing_process(::experience::enum_frame eframeSizing)
      // {
      //
...
set_interface_client_size({cx, cy});
         ...
         m_pnanodevice->on_end_draw();
            ...
            //::pointer < ::cairo::nano::graphics::device > pdevice = m_pnanodevice;

         //cairo_set_source_rgba(cr, 0.4, 0.4, 0.4, 0.4);

         //cairo_paint(cr);

         // ::rectangle_i32 r(10, 10, 400, 200);
         //
         // auto pnanobrush = __create<::nano::graphics::brush>();
         //
         // auto pnanopen = __create<::nano::graphics::pen>();
         //
         // pnanopen->m_iWidth = 4;
         // pnanopen->m_color = ::color::blue;
         //
         // pnanobrush->m_color = ::color::cyan;
         //
...
//m_pointWindow = m_puserinteractionbase->m_rectangle.top_left();
  //                       m_sizeWindow = m_puserinteractionbase->m_rectangle.size();
      ...
      //
         ...
         //      {
         //
         //         m_puserinteractionbase->m_rectangle.left() = pevent->xconfigure.x;
         //
         //         m_puserinteractionbase->m_rectangle.top() = pevent->xconfigure.y;
         //
         //         m_puserinteractionbase->m_rectangle.right() = pevent->xconfigure.x + pevent->xconfigure.width;
         //
         //         m_puserinteractionbase->m_rectangle.bottom() = pevent->xconfigure.y + pevent->xconfigure.height;
         //
         //         if (m_psurface)
         //         {
         //
         //            cairo_xlib_surface_set_size(m_psurface, m_puserinteractionbase->m_rectangle.width(),
         ...
         //
         //            auto w = m_puserinteractionbase->m_rectangle.width();
         //
         //            auto h = m_puserinteractionbase->m_rectangle.height();
         //
         ...
         if (m_pnanodevice)
            {
               ...
               //::windowing::window_base::_update_window();
         ...
         // {
         //
         //    window::__handle_pointer_motion(pwlpointer, millis);
         //
         //    //m_pointCursor2 = m_pointPointer;
         //
         //    auto pmouse = __create_new<::user::mouse>();
         ...
         // void
         // window::__handle_pointer_leave(::wl_pointer * pwlpointer, ::wayland::nano::user::window * pwaylandwindowLeave)
         // {
         //
         //    ::string strType = ::type(get_interface_client_particle()).name();
         //
         ...
         // {
         //
         //    window::__handle_pointer_button(pwlpointer, linux_button, pressed, millis);
         //
         //
         //    auto pmouse = __create_new<::user::mouse>();
         //    //
