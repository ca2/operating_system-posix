...
namespace windows
{
   ...
   bool interaction_impl::__windows_message_bypass(::acme::windowing::window * pacmewindowingwindow, ::enum_message emessage, ::wparam wparam, ::lparam lparam, LRESULT & lresult)
   {
