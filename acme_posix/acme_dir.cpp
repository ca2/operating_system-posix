...
#pragma pop_macro("get_system()")
   ...
   //{
      ...
      bool acme_dir::mk(const ::file::path & path)
      {
      ...
      bool acme_dir::_mk(const ::file::path & path)
      {
      ...
      bool acme_dir::mkdir(const ::file::path & path)
      {
      ...
      bool acme_dir::is(const ::file::path & path)
      {
      ...
      string acme_dir::name(string path)
      {
      ...
      void acme_dir::rls(::file::patha & stra, const file::path & psz)
      {
      ...
      void acme_dir::rls_dir(::file::patha & stra, const ::file::path & psz)
      {
      ...
      void acme_dir::ls(::file::patha & stra, const ::file::path & psz)
      {
      ...
      void acme_dir::ls_dir(::file::patha & stra, const ::file::path & psz)
      {
      ...
      void acme_dir::ls_file(::file::patha & stra, const ::file::path & psz)
      {
