...
//#endif
      ...
      int command_system_memory(const ::scoped_string & scopedstr, const memory_dump_function & memorydumpfunction = nullptr, const ::file::path & pathWorkingDirectory ={}, ::e_display edisplay = e_display_none) override;
