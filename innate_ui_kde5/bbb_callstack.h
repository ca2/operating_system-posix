...
namespace windows
{
   ...
   class CLASS_DECL_ACME_WINDOWS callstack :
      public ::callstack
   {
   public:
      ...
      callstack(const ::string & pszFormat = default_format(), i32 iSkip = CALLSTACK_DEFAULT_SKIP_TRIGGER, void* caller_address = nullptr, int iCount = -1);
      virtual ~callstack();
